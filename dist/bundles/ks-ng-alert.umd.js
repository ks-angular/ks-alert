(function (global, factory) {
	...
	(factory((global['ks-ng-alert'] = {}),global.ng.core,global.Rx,global.ng.common));
...
var AlertComponent = /** @class */ (function () {
    function AlertComponent(injector) {
        ...
        this.elementRef = injector.get(core.ElementRef);
        this.changeDetectorRef = injector.get(core.ChangeDetectorRef);
        this.alertConfig = injector.get('alertConfig', {});
        this.disabled = true;
        this.request = {};
        this.options = Object.assign({}, this.alertConfig.options);
        this._subscriptions = [];
        this._resSubject = new Subject.Subject();
...
AlertComponent.propDecorators = {
    ...
    "keyUp": [{ type: core.HostListener, args: ['window:keyup', ['$event'],] },],
};
var ALERT_BUTTONS = [
...
AlertService.ctorParameters = function () { return [
    ...
    { type: IAlertConfig, decorators: [{ type: core.Inject, args: ['alertConfig',] },] },
    { type: core.Injector, },
]; };
...
exports.AlertButtonType = AlertButtonType;
...
exports.ALERT_BUTTONS = ALERT_BUTTONS;
...
//# sourceMappingURL=ks-ng-alert.umd.js.map
